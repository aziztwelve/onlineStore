...
class SaleController extends Controller
{
    public function getProducts()
    {
    	...
    	return view('admin.content.sale.sale')->with($data);
    }
        ...
        public function AdminProducts($id, Request $request)
        {
                if ($request->isMethod('delete')) {
                    ...
                    $delete->delete();
                    return redirect('admin/content/sale')->with('success', 'Товар Удален');
            }
            ...
            $product_add->save();
            return redirect('admin/content/sale')->with('success', 'Товар изменен');
        }
        ...
        if (view()->exists('admin.content.sale.edit')) {
            $data = [
            ...
            // dd($data);
        return view('admin.content.sale.edit',['edit'=>$edit, 'brands'=>$brandList, 'brandId'=>$editB]);
        }
        }
}
