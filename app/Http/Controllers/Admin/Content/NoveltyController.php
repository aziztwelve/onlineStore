...
class NoveltyController extends Controller
{
    public function getProducts()
    {
    	...
    	return view('admin.content.novelty.novelty')->with($data);
    }
        ...
        public function AdminProducts($id, Request $request)
        {
                if ($request->isMethod('delete')) {
                    ...
                    $delete->delete();
                    return redirect('admin/content/novelty')->with('success', 'Товар Удален');
            }
            ...
            $product_add->save();
            return redirect('admin/content/novelty')->with('success', 'Товар изменен');
        }
        ...
        if (view()->exists('admin.content.novelty.edit')) {
            $data = [
            ...
            // dd($data);
        return view('admin.content.novelty.edit',['edit'=>$edit, 'brands'=>$brandList, 'brandId'=>$editB]);
        }
        }
}
